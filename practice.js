...
var multiplesOfFive = function (numbers) {
  /*
  I - numbers array
  O - returns a number of multiples of 5
  C - do not use .forEach()
  E - ?
*/
  var result = 0;
...
/*
I - tweets (array of objects) and user name
O - array containing only tweets belonging to a user
C -
E - if the user is unknown, return an empty array
*/
  var userTweets = [];
...
var glutenFree = function (desserts) {
  var mapped = _.map(desserts, function(dessert) {
...
var sumTotal = function (products) {
  return _.reduce(products, function(accumulator, currentValue) {
    return accumulator + Number(currentValue.price.slice(1));
  }, 0);
};
...
var dessertCategories = function (desserts) {
  return _.reduce(desserts, function(accumulator, currentValue) {
...
var countMessagesPerUser = function(tweets) {
  return _.reduce(tweets, function(accumulator, currentValue) {
    if (accumulator[currentValue.user] === undefined) {
      accumulator[currentValue.user] = 1;
    } else {
      accumulator[currentValue.user]++;
    }
    return accumulator;
  }, {});
};
...
var ninetiesKid = function (movies) {
  return _.reduce(movies, function(accumulator, currentValue) {
    if (currentValue.releaseYear > 1990
      && currentValue.releaseYear < 2000) {
